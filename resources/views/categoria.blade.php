                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-9 col-sm-4 col-md-4 col-lg-4 producto">
                                ...
                                <h5 class="textos-cafes"><a href="{{ url('productos/detalle') }}/{{ $producto->id_producto }}" class="textos-cafes">{{ $producto->nombre_producto }}</a></h5>
                            ...
                            <div class="col-10 col-sm-6 text-center pro-pagination">
                                <div class="col-12 text-center">
                                    <ul class="m-0">
                                        ...
                                        <li class="textos-cafes"><a href="" class="textos-cafes">1</a></li>
                                        <li class="textos-cafes">de</li>
                                        <li class="textos-cafes"><a href="" class="textos-cafes">5</a></li>
                                    </ul>
                                </div>
                            </div>
